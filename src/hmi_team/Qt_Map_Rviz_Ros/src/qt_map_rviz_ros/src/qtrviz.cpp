...
QtRviz::QtRviz(QVBoxLayout * layout, QString nodeName)
{
  ...
  // Load the initial RViz configuration from test.yaml 경로 맞춰서 바꾸기!!
  QString path = "/home/osh/SVE_0614/SVE_graduation_ws_0613/src/hmi_team/Qt_Map_Rviz_Ros/src/qt_map_rviz_ros/rviz/grad_proj.yaml"; // Change to the correct path
  ReadDispSet(path);
}
