...
MainWindow::MainWindow(int argc, char ** argv, QWidget *parent) :
  QMainWindow(parent),
  qtNode(argc,argv), // qtNode = qnode
  ui(new Ui::MainWindow)
{
  if(qtNode.init()) isConnected = true; //
  // home by enter 버튼 -> move_mode 
  // ------home 에서 moving open 
  QObject::connect(&qtNode, SIGNAL(home_ui()),this,SLOT(open_w1())); //
  ...
  // home by enter 버튼 -> move_mode 
  // ------home 에서 moving open 
  connect(&qtNode, SIGNAL(home_ui()),this,SLOT(open_w1())); //
//============================================
  if(ui->checkbox_remember_settings->isChecked())
  {
    ...
    initial_Rviz_connect(); // Rviz Initial
  }
  connections();
}
//============================================
...
/////////////////
void MainWindow::shownoROSmaster() //
{
    QMessageBox msgBox;
...
{
    MainWindow::back = 1;
    qtNode.num_back.data = MainWindow::back;
    qtNode.send_back();
    this->hide();
}
...
// ======================================
// move -> take
void MainWindow::on_pb_arrived_clicked()
{
    MainWindow::take = 1;
    qtNode.num_take.data = MainWindow::take;
    qtNode.send_take();
    this->hide();
}
// ======================================
...
void MainWindow::readSettings()
{
  ...
  QString masterUrl = settings.value("master_url", QString("http://localhost:34241")).toString(); // 
...
//============================================
void MainWindow::initial_Rviz_connect() {
